...
- **Copilot Instructions** — `template/.github/copilot-instructions.md` and the `template/.github/trellis-api-*.md` reference files ship with the template to guide AI assistants toward Trellis patterns.
